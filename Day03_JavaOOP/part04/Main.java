...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Employee Qa1 = new Qa("Dodi",
                LocalDate.of(2025, 1, 12), 6_000_000, 500_000);

        Employee sales1 = new Sales("manuel",
                LocalDate.of(2025, 1, 12), 6_000_000, 500_000, 1_000_000);


        List<Employee> listEmployee= List.of(emp1,emp2,emp3,prog1,emp5, Qa1, sales1);
